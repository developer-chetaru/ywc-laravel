...
#[Layout('layouts.app')]
class ContractorReviewShow extends Component
{
    use WithPagination;
    ...
    public function voteHelpful($reviewId)
    {
        ...
        $review = ContractorReview::findOrFail($reviewId);
    ...
    public function render()
    {
        ...
        return view('livewire.industry-review.contractor-review-show', [
            'reviews' => $reviews,
        ]);
    }
}
