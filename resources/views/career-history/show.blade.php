...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.view-doc-btn').forEach(el=>{
        el.addEventListener('click',function(e){
            ...
            byId('viewDocName').textContent=doc.type==='passport'?'Passport':doc.type==='idvisa'?'ID / Visa':doc.type==='certificate'?doc.certificates?.[0]?.type?.name||'Certificate':doc.type==='other'?getRelation(doc,'other_document','otherDocument','otherdocument')?.doc_name||'Other Document':doc.name||'-';
