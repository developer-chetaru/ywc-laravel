                ...
                <div class="overflow-hidden p-5 mt-6 bg-[#F5F6FA]" style="border-top:8px solid #0053FF; border-radius:1.5rem;">
                    ...
                    @if(!$subscription || $subscription->end_date < now())
                        ...
                        <div class="bg-white rounded-md p-5 border border-[#0053FF] max-w-[538px] mt-2 subscription-box">
                            <h2 class="text-[30px] text-[#0053FF] font-semibold mb-4">£50/Month</h2>
                    ...
                    @else
                        ...
                        <div class="flex justify-between items-center mb-5">
                            ...
                            <a href="#"
                            class="flex border rounded-sm px-5 py-2 bg-white text-[16px] text-[#0053FF] border-[#0053FF]">
                                Invoice
                            </a>
                        </div>
                        ...
                        <div class="flex gap-10 flex-wrap">
                            <div class="grid">
                                ...
                                <span class="text-[18px] text-[#1B1B1B] font-medium">
                                    £{{ number_format($subscription->amount / 100, 2) }}/Month
                                </span>
                            </div>
                            <div class="grid">
                            ...
                            <div class="grid">
                                ...
                                <span class="text-[18px] text-[#1B1B1B] font-medium">
                                    {{ $subscription->interval_count ?? 1 }} {{ ucfirst($subscription->interval ?? 'Month') }}
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="flex gap-10 flex-wrap mt-8">
                            ...
                            <div class="grid">
                                <span class="text-[14px] text-[#616161] mb-1">Valid Till</span>
                                @php
                                    $endDate = \Carbon\Carbon::parse($subscription->end_date)->subDay(); // subtract 1 day
                                    $daysLeft = now()->diffInDays($endDate, false);
                                @endphp

                                <span class="text-[18px] font-medium {{ $daysLeft < 1 ? 'text-red-500' : 'text-[#1B1B1B]' }}">
                                    {{ $endDate->format('d M Y') }}
                                </span>

                                {{-- Check if less than 1 day left --}}
                                @if($daysLeft < 1)
                                    <span class="text-red-500 text-sm mt-1">⚠️ Expiring Soon</span>
                                @endif
                            </div>
                        </div>
                    @endif
