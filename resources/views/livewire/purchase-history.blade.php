    ...
    <div class="w-full h-screen gap-5 flex flex-wrap md:flex-nowrap grid-cols-4 grid">
            ...
            <ul class="mb-4">
                <li>
                    <a href="{{ route('profile') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg transition
                        {{ $currentRoute == 'profile' ? 'text-blue-600' : 'text-black' }}">
                        ...
                        <span class="text-base font-medium {{ $currentRoute == 'profile' ? 'text-blue-600' : 'text-black' }}">Your profile</span>
                    </a>
                </li>

                <li>
                    <a href="{{ route('profile.password') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg transition
                        {{ $currentRoute == 'profile.password' ? 'text-blue-600' : 'text-black' }}">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <span class="text-base font-medium {{ $currentRoute == 'profile.password' ? 'text-blue-600' : 'text-black' }}">Change Password</span>
                    </a>
                </li>
            </ul>
            ...
            <ul>
                <li>
                    <a href="{{ route('subscription.page') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg transition
                        {{ $currentRoute == 'subscription.page' ? 'text-blue-600' : 'text-black' }}">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <span class="text-base font-medium {{ $currentRoute == 'subscription.page' ? 'text-blue-600' : 'text-black' }}">Subscription</span>
                    </a>
                </li>

                <li>
                    <a href="{{ route('purchase.history') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg transition
                        {{ $currentRoute == 'purchase.history' ? 'text-blue-600' : 'text-black' }}">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                            class="{{ $currentRoute == 'purchase.history' ? 'stroke-blue-600' : 'stroke-black' }}">
                            <path d="M4 18.6458V8.05426C4 5.20025 4 3.77325 4.87868 2.88663C5.75736 2 7.17157 2 10 2H14C16.8284 2 18.2426 2 19.1213 2.88663C20 3.77325 20 5.20025 20 8.05426V18.6458C20 20.1575 20 20.9133 19.538 21.2108C18.7831 21.6971 17.6161 20.6774 17.0291 20.3073C16.5441 20.0014 16.3017 19.8485 16.0325 19.8397C15.7417 19.8301 15.4949 19.9768 14.9709 20.3073L13.06 21.5124C12.5445 21.8374 12.2868 22 12 22C11.7132 22 11.4555 21.8374 10.94 21.5124L9.02913 20.3073C8.54415 20.0014 8.30166 19.8485 8.03253 19.8397C7.74172 19.8301 7.49493 19.9768 6.97087 20.3073C6.38395 20.6774 5.21687 21.6971 4.46195 21.2108C4 20.9133 4 20.1575 4 18.6458Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M11 11H8" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M14 7H8" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        <span class="text-base font-medium {{ $currentRoute == 'purchase.history' ? 'text-blue-600' : 'text-black' }}">Purchase History</span>
                    </a>
                </li>
            </ul>
            @endrole
        ...
        <!-- Main Content -->
         <div class="bg-white p-5 rounded-lg shadow-md col-span-3">
            <div class="w-full">
                <h2 class="text-xl border-b border-gray-100 font-medium text-[#0053FF] pb-2">Purchase History</h2>

                <div class="flex items-center justify-center h-40">
                    <p class="text-gray-500 text-lg font-medium">Purchase History Coming Soon...</p>
                </div>
            </div>
        </div>
    </div>
