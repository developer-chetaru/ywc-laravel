                ...
                <div class="flex-1">
                    ...
                    <div class="mt-4 flex gap-3 flex-wrap">
                        ...
                        @php
                            ...
                            $activeDiscussion = $discussionService->getActiveDiscussion('industry_reviews', $contractor->id, 'contractor');
                        @endphp
                        @if($activeDiscussion)
                        ...
                        @else
                            <x-start-discussion-button 
                                ...
                                itemType="contractor" 
                                :itemTitle="$contractor->name"
                                :itemUrl="route('contractor-reviews.show', $contractor->slug)" />
                        @endif
                    </div>
                </div>
            </div>
