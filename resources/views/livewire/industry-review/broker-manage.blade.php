    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white shadow-lg rounded-xl p-6 border border-gray-200">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                ...
                <a href="{{ route('industryreview.brokers.create') }}" class="inline-flex items-center justify-center px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 transition-all">
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-4 py-3">
                                    <div class="flex items-center gap-3">
                                        @if($broker->logo)
                                            ...
                                            @endphp
                                            <img src="{{ $logoUrl }}" alt="{{ $broker->name }}" class="w-10 h-10 rounded object-cover" onerror="this.style.display='none'">
                                        @endif
                                ...
                                <td class="px-4 py-3 text-center">
                                    <div class="flex items-center justify-center gap-2">
                                        <a href="{{ route('industryreview.brokers.edit', $broker->id) }}" class="p-2 text-blue-600 hover:bg-blue-50 rounded-lg" title="Edit">
