            ...
            <div class="flex flex-col md:flex-row gap-6">
                ...
                <div class="flex-1">
                    ...
                    <div class="mt-4 flex gap-3">
                        <a href="{{ route('restaurant-reviews.create', $restaurant->id) }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
        ...
        <div class="space-y-6">
            ...
            @else
                <div class="bg-white shadow-lg rounded-xl p-12 text-center">
                    ...
                    <a href="{{ route('restaurant-reviews.create', $restaurant->id) }}" class="inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
