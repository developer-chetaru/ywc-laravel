        ...
        @if(isset($showMyReviews) && $showMyReviews && isset($reviews))
                        ...
                        <div class="bg-white shadow-lg rounded-xl p-6 border border-gray-200">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="flex items-center gap-4 mb-3">
                                    @if($review->marina)
                                        <a href="{{ route('marina-reviews.show', $review->marina->slug) }}" class="text-blue-600 hover:text-blue-700 font-medium">
                                            {{ $review->marina->name }}
                                        </a>
                                    @else
                                        <span class="text-gray-500 font-medium">Marina Deleted</span>
                                    @endif
                                </div>
                            ...
                            @if($review->tips_tricks)
                                <div class="bg-blue-50 p-3 rounded-lg mb-4">
                                    <div class="text-sm font-semibold text-blue-800 mb-1">Tips & Tricks</div>
                                    <p class="text-sm text-blue-700">{{ Str::limit($review->tips_tricks, 150) }}</p>
                                </div>
                            @endif
                            ...
                            <div class="flex items-center justify-between pt-4 border-t border-gray-200">
                                ...
                                @if($review->marina)
                                    <a href="{{ route('marina-reviews.show', $review->marina->slug) }}" class="text-blue-600 hover:text-blue-700 text-sm font-medium">
                                        View Full Review →
                                    </a>
                                @else
                                    <span class="text-gray-400 text-sm">Marina no longer available</span>
                                @endif
                            </div>
                        </div>
                    @endforeach
            ...
            @else
                <div class="bg-white rounded-xl shadow-lg p-12 text-center">
                    ...
                    <p class="text-gray-600 mb-6">You haven't written any marina reviews yet.</p>
                    <a href="{{ route('marina-reviews.create') }}" class="inline-block px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
                        Write Your First Review
                    </a>
                </div>
            @endif
        @elseif($marinas->count() > 0)
