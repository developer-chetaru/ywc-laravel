        ...
        <div class="bg-white shadow-lg rounded-xl p-6 border border-gray-200">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    ...
                    @endauth
                    <a href="{{ route('broker-reviews.create') }}"
        ...
        @if(isset($showMyReviews) && $showMyReviews && isset($reviews))
                        ...
                        <div class="bg-white shadow-lg rounded-xl p-6 border border-gray-200">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="flex items-center gap-4 mb-3">
                                    @if($review->broker)
                                        <a href="{{ route('broker-reviews.show', $review->broker->slug) }}" class="text-blue-600 hover:text-blue-700 font-medium">
                                            {{ $review->broker->name }}
                                        </a>
                                    @else
                                        <span class="text-gray-500 font-medium">Broker Deleted</span>
                                    @endif
                                </div>
                            ...
                            <div class="flex items-center justify-between pt-4 border-t border-gray-200">
                                <div class="flex items-center gap-4 text-sm text-gray-600">
                                    @if($review->position_placed)
                                        <span>Position: {{ $review->position_placed }}</span>
                                    @endif
                                </div>
                                @if($review->broker)
                                    <a href="{{ route('broker-reviews.show', $review->broker->slug) }}" class="text-blue-600 hover:text-blue-700 text-sm font-medium">
                                        View Full Review →
                                    </a>
                                @else
                                    <span class="text-gray-400 text-sm">Broker no longer available</span>
                                @endif
                            </div>
                        </div>
                    @endforeach
            ...
            @else
                <div class="bg-white rounded-xl shadow-lg p-12 text-center">
                    ...
                    <p class="text-gray-600 mb-6">You haven't written any broker reviews yet.</p>
                    <a href="{{ route('broker-reviews.create') }}" class="inline-block px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
                        Write Your First Review
                    </a>
                </div>
            @endif
        @elseif($brokers->count() > 0)
