    ...
    <main class="flex-1">
        ...
        <div class="flex gap-[16px] mb-6" id="forumTabs">
            ...
            <div data-tab="forums" 
                ...
                <p class="font-semibold text-[#808080] text-md">Total Forums</p>
                <span class="font-semibold text-[#1B1B1B] text-xl">7</span>
                <img src="./image/message-multiple-01.svg" alt="" class="-translate-y-1/2 absolute right-6 top-1/2">
            </div>
            ...
            <div data-tab="threads"
                class="tab-btn cursor-pointer relative flex-1 flex-col justify-center flex border border-[#BDBDBD] 
                bg-white rounded-lg py-4 px-6 pr-12 hover:bg-[#F8F9FA] transition">
                <p class="font-semibold text-[#808080] text-md">Total Threads</p>
                <span class="font-semibold text-[#1B1B1B] text-xl">22</span>
                <img src="./image/wechat.svg" alt="" class="-translate-y-1/2 absolute right-6 top-1/2">
            </div>
            ...
            <div data-tab="create-forum"
                class="tab-btn cursor-pointer relative flex-1 flex-col justify-center flex border border-[#BDBDBD] 
                bg-white rounded-lg py-4 px-6 pr-12 hover:bg-[#F8F9FA] transition">
                <p class="font-semibold text-[#808080] text-md">Create New Forum</p>
                <img src="./image/add-circle-blue.svg" alt="" class="-translate-y-1/2 absolute right-6 top-1/2">
            </div>
        </div>
        ...
        <div id="chatLayout" class="flex h-[calc(100vh-160px)] gap-x-[24px] bg-gray-100 mt-4">
                        ...
                        <h4 class="font-medium text-[#808080] mb-[13px] hover:text-[#1B1B1B] flex justify-between gap-2 items-start cursor-pointer px-5 !pl-[40px]"
                            ...
                            <div class="flex flex-col">
                                ...
                                <div class="flex items-center gap-3 text-gray-500 mt-3">
                                    ...
                                    <a href="{{ route('category.edit', ['category_id' => $category->id, 'category_slug' => $category->title]) }}"
                                        class="flex items-center gap-1 text-[13px] text-[#808080] hover:text-black transition">
                                        <img src="{{ asset('images/pencil-edit-01.svg') }}" alt="Edit Icon" class="w-4 h-4">
                                        <span>Edit</span>
                                    </a>
                                    <a href="{{ Forum::route('thread.create', $category) }}" 
                                        class="flex items-center gap-1 text-[13px] text-[#808080] hover:text-black transition">
                                        <img src="{{ asset('images/add-circle.svg') }}" alt="Add Icon" class="w-4 h-4">
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        if (backButton) {
            backButton.addEventListener("click", function () {
                ...
                // Hide all tab contents (reset)
                tabContents.forEach(content => content.classList.add("hidden"));

                // Remove active highlight from all tabs
                tabs.forEach(t => t.classList.remove("!bg-blue-50", "!border-blue-500"));

                // Show chat layout again
                chatLayout.classList.remove("hidden");
            });
        }
    });
